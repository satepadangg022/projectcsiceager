  ...
  <div class="wrap">
    ...
    <div class="berita-grid">
      ...
      <a href="{{ route('detail.berita', $b->id) }}" class="news-card reveal">
        <div class="news-img">
          @if(!empty($b->img))
            <img src="{{ url($b->img) }}" loading="eager" alt="{{ $b->title }}">
          @else
        ...
        <div class="carousel-track" id="info-track">
          ...
          <div class="info-slide">
            <div class="info-card" data-bs-toggle="modal" data-bs-target="#infografisModal{{ $info->id }}">
              <img src="{{ url($info->img) }}" loading="eager" alt="{{ $info->name }}" class="info-img">
              <div class="info-foot">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-body text-center p-4">
        ...
        <img src="{{ url($info->img) }}" loading="eager" class="img-fluid" alt="{{ $info->name }}">
      </div>
    </div>
  </div>
</div>
        ...
        <div class="carousel-track" id="event-track">
          ...
          <div class="event-slide">
            <div class="event-card" data-bs-toggle="modal" data-bs-target="#modalKegiatan{{ $k->id }}">
              <div class="event-img">
                @if(!empty($k->img))
                  <img src="{{ url($k->img) }}" loading="eager" alt="{{ $k->name }}">
                @else
...
<div class="modal fade" id="modalKegiatan{{ $k->id }}" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-4">
        @if($k->img)
        <img src="{{ url($k->img) }}" loading="eager" class="img-fluid mb-3" alt="{{ $k->name }}">
        @endif
        @if($k->resume)
